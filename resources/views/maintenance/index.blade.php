<!-- filepath: /c:/Users/danie/OneDrive/Documenten/school mappen/Leerjaar 2/Project/Periode 3/traveleasy/resources/views/maintenance/index.blade.php -->
<!DOCTYPE html>
<html lang="nl">
<head>
    <meta charset="UTF-8">
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white bg-opacity-80 p-6 sm:p-8 md:p-12 rounded-lg shadow-lg text-center">
        ...
        <p class="text-lg">Bedankt voor uw geduld!</p>
    </div>
</body>
</html>