        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden p-6">
            <form action="{{ route('bookings.update', $booking->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="customer_id" id="customer_id" class="w-full p-2 border border-gray-300 rounded mt-1" value="{{ $booking->customer_id }}" required>
                </div>
                <div class="mb-4">
                    <label for="travel_id" class="block text-gray-700">Reis ID</label>
                    <input type="text" name="travel_id" id="travel_id" class="w-full p-2 border border-gray-300 rounded mt-1" value="{{ $booking->travel_id }}" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="purchase_date" id="purchase_date" class="w-full p-2 border border-gray-300 rounded mt-1" value="{{ $booking->purchase_date }}" required>
                </div>
                <div class="mb-4">
                    <label for="purchase_time" class="block text-gray-700">Aankooptijd</label>
                    <input type="time" name="purchase_time" id="purchase_time" class="w-full p-2 border border-gray-300 rounded mt-1" value="{{ $booking->purchase_time }}" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="quantity" id="quantity" class="w-full p-2 border border-gray-300 rounded mt-1" value="{{ $booking->quantity }}" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select name="is_active" id="is_active" class="w-full p-2 border border-gray-300 rounded mt-1" required>
                        <option value="1" {{ $booking->is_active ? 'selected' : '' }}>Ja</option>
                        <option value="0" {{ !$booking->is_active ? 'selected' : '' }}>Nee</option>
                    </select>
                </div>
                <div class="mb-4">
