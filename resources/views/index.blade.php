        ...
        <div class="container mx-auto px-4 py-16 text-center relative z-10 flex items-center justify-center h-full">
            <div>
                ...
                <form action="{{ url('/bookings') }}" method="GET" class="mt-8 flex justify-center">
                    ...
                    <input type="number" name="min_price" placeholder="Min Prijs" class="py-3 px-1 border-none focus:outline-none w-24">
                    <input type="number" name="max_price" placeholder="Max Prijs" class="py-3 px-1 border-none focus:outline-none w-24">
